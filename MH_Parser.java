...
class MH_Parser extends GenParser implements PARSER {
    ...
    String[] tableEntry (String nonterm, String tokClass) {
      ...
      if (nonterm.equals("#Exp")) {
        if (tokClass.equals("VAR") || tokClass.equals("NUM") || tokClass.equals("BOOLEAN")
        || tokClass.equals("(")) {
          return Exp0;
        }
      ...
      if (nonterm.equals("#Rest1")) {
        if (tokClass.equals("then") || tokClass.equals("else") || tokClass.equals(")") ||
        tokClass.equals(";") || tokClass.equals("==") || tokClass.equals("<=")) {
          return epsilon;
        }
        else if(tokClass.equals("+")) {
      ...
      if (nonterm.equals("#Rest2")) {
        if (tokClass.equals("then") || tokClass.equals("else") || tokClass.equals(")")
         ...
         else if (tokClass.equals("VAR") || tokClass.equals("NUM") || tokClass.equals("BOOLEAN") || tokClass.equals("(")) {
           return Exp3_Rest2;
         }
         else {
           System.out.println("Incorrect grammar");
